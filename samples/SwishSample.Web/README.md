...
```powershell
git clone https://github.com/NordAPI/NordAPI.SDK.git
cd NordAPI.SDK
dotnet run --project .\samples\SwishSample.Web\SwishSample.Web.csproj --urls http://localhost:5000
```
...
- Integration checklist (web): https://nordapi.net/integration-checklist/
- Integration checklist (repo): ../../docs/integration-checklist.md
